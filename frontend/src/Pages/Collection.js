        ...
        {showSearchbar && (
          <div className=" ml-24 mr-24">
            <div className="mt-6 flex justify-center items-center relative ">
              ...
              <div
                className="cursor-pointer  text-xl font-normal h-6 w-6 flex justify-center items-center close-button"
        ...
        <div className="w-3/4 mt-8">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-semibold text-[#707070]">
              ...
              <img
                className="inline-block ml-2 h-0.5 w-12"
                src={border}
                alt="img-border"
              />
            </h1>
              ...
              sortedProducts.map((i) => (
                <div key={i.id}>
                  <Link to={`/product/${i._id}`}>
                    <img
                      className="transition ease-in-out hover:scale-105 w-56 h-56"
                      src={i.image}
                      alt={i.name}
                    />
                  </Link>
                  <p className="text-sm font-medium text-[#494949] mt-2">
                    {i.name}
                  </p>
                  <p className="text-sm font-medium text-[#494949] mt-2">
                    ${i.price}
