...
function Collection() {
  ...
  return (
    <section >
      ...
      <div className="ml-32 text-2xl leading-7 text-[#343434] mt-28 ">Filters</div>
      <div className="border-solid border-2 w-[215px] h-40 ml-32 mt-4 ">
        <div className="font-normal text-lg pl-3 leading-5 text-[#212121] mt-2">CATEGORIES</div>
        <div className="space-y-2 flex flex-col">
        <label  >
          <input type="checkbox" className="h-3 w-3 rectangle mt-5 ml-5 text-sm leading-5 font-light text-[#272727]" />  Men
        </label>
        <label>
          <input type="checkbox" className="h-3 w-3 rectangle  ml-5 text-sm leading-5 font-light text-[#272727]" />  Women
        </label>
        <label>
          <input type="checkbox" className="h-3 w-3 rectangle ml-5 text-sm leading-5 font-light text-[#272727]" />  Kids
        </label>
        </div>
      </div>
      <div className="border-solid border-2 w-[215px] h-40 ml-32 mt-6 ">
        <div className="font-normal text-lg pl-3 leading-5 text-[#212121] mt-2">TYPE</div>
        <div className="space-y-2 flex flex-col">
        <label  >
          <input type="checkbox" className="h-3 w-3 rectangle mt-5 ml-5 text-sm leading-5 font-light text-[#272727]" />  Topwear
        </label>
        <label>
          <input type="checkbox" className="h-3 w-3 rectangle  ml-5 text-sm leading-5 font-light text-[#272727]" />  Bottomwear
        </label>
        <label>
          <input type="checkbox" className="h-3 w-3 rectangle ml-5 text-sm leading-5 font-light text-[#272727]" />  Winterwear
        </label>
        </div>
        </div>
      </div>
      ...
      <div className="flex ml-10">
        <div className="mt-20  font-semibold text-4xl leading-10 text-[#707070] flex">
          ...
          <img className="h-[2px] w-12 mt-6 ml-2 " src={border} alt="img-border" />
          </div>
