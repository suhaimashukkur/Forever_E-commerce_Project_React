        ...
        <form>
          <div className="flex flex-col space-y-4 ml-32 mt-20 ">
            <div className="flex gap-2">
              <label className=" border-solid border-2 h-10 w-[256px] border-[#707070] ">
                <input
                  type="text"
            ...
            <label className=" border-solid border-2 h-10 w-[520px] border-[#707070]">
         ...
         <div className="flex flex-col  space-y-4">
               ...
               <div className="flex  ml-28 ">
                       <div className="mt-14 font-normal text-lg leading-9 text-[#707070]">
                         PAYMENT{" "}
                  ...
                  <button style={{marginTop:"30px"}}className="border-solid border-2 h-12 w-60  bg-black text-white ml-[330px] " onClick={handlePlaceOrder}>PLACE ORDER</button>
